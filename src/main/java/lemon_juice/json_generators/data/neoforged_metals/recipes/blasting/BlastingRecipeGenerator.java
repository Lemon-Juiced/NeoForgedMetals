package lemon_juice.json_generators.data.neoforged_metals.recipes.blasting;
...
public class BlastingRecipeGenerator {
    public static void blastingRecipeGenerator(){
    ...
    public static String generateDustRecipeName(String name){
        return "src/main/resources/data/neoforged_metals/recipes/blasting/dust/" + name + ".json";
    }

    public static String generateOreRecipeName(String name){
        return "src/main/resources/data/neoforged_metals/recipes/blasting/ore/" + name + ".json";
    }

    public static String generateRawRecipeName(String name){
        return "src/main/resources/data/neoforged_metals/recipes/blasting/raw/" + name + ".json";
    }
